...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To GridView1.Rows.Count - 1
            ...
            mailsub = "TKE Sommerfest 2016 – kleine Erinnerung"
            ...
            text = text & "                                                vor einigen Tagen hast Du die Einladung zum<br />TKE Sommerfest <b>am 16. September 2016</b> erhalten."
            text = text & "                                            </p>"
            text = text & "                                            <p style=""text-align:center;"">"
            text = text & "                                                Damit Du die An-/Abmeldefrist nicht verpasst,<br />möchten wir Dich heute freundlich erinnern, dass<br />die An-/Abmeldung nur noch bis<br />zum <b>02. September 2016</b> möglich ist."
            text = text & "                                            </p>"
            text = text & "                                            <p style=""text-align:center;"">"
            text = text & "                                               Klicke einfach auf eines der unten stehenden Felder,<br />um Dich verbindlich zum Sommerfest an- oder abzumelden."
            text = text & "                                            </p>"
            ...
            text = text & "<p style=""text-align:center;"">"
            text = text & "Wir würden uns sehr freuen, auch Dich<br />begrüßen zu dürfen!"
            text = text & "</p>"
            ...
            plaintext = plaintext & "vor einigen Tagen hast Du die Einladung zum" & vbNewLine & "TKE Sommerfest am 16. September 2016 erhalten." & vbNewLine & vbNewLine
            plaintext = plaintext & "Damit Du die An-/Abmeldefrist nicht verpasst," & vbNewLine & "möchten wir Dich heute freundlich erinnern, dass" & vbNewLine & "die An-/Abmeldung nur noch bis" & vbNewLine & "zum 02. September 2016 möglich ist." & vbNewLine & vbNewLine
            plaintext = plaintext & "Klicke einfach auf einen der unten stehenden Links," & vbNewLine & "um Dich verbindlich zum Sommerfest an- oder abzumelden." & vbNewLine & vbNewLine
            ...
            plaintext = plaintext & "Wir würden uns sehr freuen, auch Dich" & vbNewLine & "begrüßen zu dürfen!" & vbNewLine & vbNewLine
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Canon %>"
            ...
            SelectCommand="SELECT Top(500) id, Anrede, Vorname, Nachname, EMail, Hash FROM Canon_Einladung WHERE (Rueckmeldung = 0) and id > 3105">
        </asp:SqlDataSource>
    </div>
    </form>
</body>
