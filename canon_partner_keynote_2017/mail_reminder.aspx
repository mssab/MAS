...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To GridView1.Rows.Count - 1
            ...
            mailsub = "Friendly Reminder– Pathfinder 2017"
            ...
            text = text & "<tr style="" vertical-align:middle;background-color:#D9D9D9;height:30px;""><td colspan=""2"" style=""vertical-align:middle;text-align:left;padding-left:28px; font-size:8pt;""><div style="" background-color:#D9D9D9;"">Sollte die E-Mail nicht richtig angezeigt werden, klicke bitte <a href=""https://pathfinder2017.vodafone-managementletter.de/email_reminder.html"" target=""_blank"" style=""color:#E60000; text-decoration: underline;"">hier</a></div> </td></tr>"
            text = text & "                    <tr>"
            ...
            text = text & "                                       <b>sichere Dir eins der letzten Tickets und melde Dich direkt für die Teilnahme am Pathfinder Event des Handelsblatts an.</b></p>"
            text = text & "                                    <p style=""color:#4A4D4E;"">"
            text = text & "                                      Gemeinsam mit mir, kannst Du am 1. Mai am <b>Pathfinder Event des Handelsblatts</b> teilnehmen. Sieben CEOs großer Unternehmen laden dort ihre Nachwuchskräfte ein, um neue Perspektiven zu entdecken und abseits von Quartalszahlen zu diskutieren – eine gute Gelegenheit zur Vernetzung über Unternehmensgrenzen hinweg."
            text = text & "                                    </p>"
            ...
            text = text & "                                    <p style=""color:#4A4D4E;"">"
            text = text & "                                        Bitte beachte: Die Teilnehmerzahl ist begrenzt, wir verfahren nach dem Motto</br>&#8222;first come, first serve&#8221;. </p>"
            text = text & "                                    <p style=""color:#4A4D4E;"">"
            ...
            plaintext = plaintext & "sichere Dir eins der letzten Tickets und melde Dich direkt für die Teilnahme am Pathfinder Event des Handelsblatts an." & vbNewLine & vbNewLine
            plaintext = plaintext & "Gemeinsam mit mir, kannst Du am 1. Mai am am 1. Mai gemeinsam mit mir am Pathfinder Event des Handelsblatts teilnehmen." & vbNewLine & " Sieben CEOs großer Unternehmen laden dort ihre Nachwuchskräfte ein, um neue Perspektiven " & vbNewLine & "zu entdecken und abseits von Quartals-zahlen zu diskutieren – eine gute Gelegenheit zur Vernetzung über Unternehmens-grenzen hinweg." & vbNewLine & vbNewLine
            ...
            plaintext = plaintext & "Bitte beachte: Die Teilnehmerzahl ist begrenzt, wir verfahren nach dem Motto „first come, first serve“"." & vbNewLine & vbNewLine
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Canon %>"
            ...
            SelectCommand="SELECT [id], [EMail], [Anrede], [Vorname], [Nachname], [Hash] FROM [Canon_Einladung] WHERE id < 225 AND id > 9 AND Rueckmeldung = 0 ">
        </asp:SqlDataSource>
    </div>
    </form>
</body>
