...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To GridView1.Rows.Count - 1
            ...
            mailsub = "Vodafone Pathfinder – Reminder Hotelzimmer"
            ...
            text = text & "                                    <p style=""color:#4A4D4E;"">"
            text = text & "                                      Nun sind es nur noch wenige Tage bis zum Event. Hast Du schon Dein Hotelzimmer gebucht? Um Dir die Vodafone Sonderrate zu sichern, hol dies bitte noch heute online nach:</p>"
            text = text & "                                    </p>"
            ...
            text = text & "                                            <tr>"
            text = text & "                                                <td>"
            text = text & "                                                    <a href=""https://www.nh-hotels.de/event/vodafone-pathfinder"" border=""0"">"
            text = text & "                                                        <img src=""https://pathfinder2017.vodafone-managementletter.de/img/Button_hotelbuchung.png"" alt="""" style=""height:35px;"" border=""0"" /></a>"
            text = text & "                                                </td>"
            text = text & "                                                "
            text = text & "                                            </tr>"
            text = text & "                                        </table>"
            ...
            plaintext = plaintext & "Nun sind es nur noch wenige Tage bis zum Event. Hast Du schon Dein Hotelzimmer gebucht?" & vbNewLine & "Um Dir die Vodafone Sonderrate zu sichern, hol dies bitte noch heute online nach:" & vbNewLine & vbNewLine
            plaintext = plaintext & "<a href=""https://www.nh-hotels.de/event/vodafone-pathfinder"" border=""0""><img src=""https://pathfinder2017.vodafone-managementletter.de/img/Button_hotelbuchung.png"" alt="""" style=""height:35px;"" border=""0"" /></a>" & vbNewLine & vbNewLine
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Canon %>"
            ...
            SelectCommand="SELECT [id], [EMail], [Anrede], [Vorname], [Nachname], [Hash] FROM [Canon_Einladung] WHERE id IN (30, 40, 46, 47, 61, 66, 67, 83, 95, 96, 99, 122, 147, 150, 164, 168, 170, 177, 179, 182, 192, 196, 205, 214, 225, 242, 252, 257, 267, 278, 289, 291, 304, 318, 319)  ">
        </asp:SqlDataSource>
    </div>
    </form>
</body>
