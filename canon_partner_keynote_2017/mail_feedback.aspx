...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To GridView1.Rows.Count - 1
            ...
            mailsub = "Vodafone Pathfinder – Feedback"
            ...
            text = text & "                                       vielen Dank für Deine Teilnahme am Handelsblatt Pathfinder Event.</p>"
            text = text & "                                    <p style=""color:#4A4D4E;"">"
            text = text & "                                      Gerne möchten wir Dich um Deine Bewertung der Veranstaltung bitten. Der Fragebogen benötigt nicht viel Zeit und hilft uns, bei künftigen Events noch besser auf Deine Erwartungen einzugehen.</p>"
            text = text & "                                    </p>"
            ...
            text = text & "                                            <tr>"
            text = text & "                                                <td>"
            text = text & "                                                    <a href=""http://www.pathfinder2017-feedback.vodafone-managementletter.de?hash=" & passwort & """ border=""0"">"
            text = text & "                                                        <img src=""https://pathfinder2017.vodafone-managementletter.de/img/button_zur_feedback_abfrage.png"" alt="""" style=""height:32px;"" border=""0"" /></a>"
            text = text & "                                                </td>"
            text = text & "                                                "
            text = text & "                                            </tr>"
            text = text & "                                        </table>"
            ...
            text = text & "                                    <p style=""color:#4A4D4E;"">"
            text = text & "                                        Danke, wir freuen uns auf Dein Feedback, übrigens nach Absenden des Feedback-Bogens findest Du unser gemeinsames Pathfinder Gruppenfoto von gestern.</p>"
            ...
            text = text & "                                    <p style=""color:#4A4D4E;"">Dein<br />Vodafone Orga-Team</p>"
            ...
            plaintext = plaintext & "vielen Dank für Deine Teilnahme am Handelsblatt Pathfinder Event." & vbNewLine & vbNewLine
            plaintext = plaintext & "Gerne möchten wir Dich um Deine Bewertung der Veranstaltung bitten. Der Fragebogen benötigt nicht viel Zeit und hilft uns, bei künftigen Events noch besser auf Deine Erwartungen einzugehen." & vbNewLine & vbNewLine
            plaintext = plaintext & "<a href=""http://www.pathfinder2017-feedback.vodafone-managementletter.de?hash=" & passwort & """ border=""0"">Zur Feedback-Abrage</a>" & vbNewLine & vbNewLine

            plaintext = plaintext & "•	Danke, wir freuen uns auf Dein Feedback, übrigens nach Absenden des Feedback-Bogens findest Du unser gemeinsames Pathfinder Gruppenfoto von gestern." & vbNewLine & vbNewLine
            ...
            Try
                ...
                de = New Net.Mail.MailAddress("pathfinder2017@vodafone-managementletter.de", "Orga-Team")
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Canon %>"
            ...
            SelectCommand="SELECT  [id], [EMail], [Anrede], [Vorname], [Nachname], [Hash] FROM [Canon_Einladung] WHERE Teilnahme = 1 and id = 5">
        </asp:SqlDataSource>
    </div>
    </form>
</body>
