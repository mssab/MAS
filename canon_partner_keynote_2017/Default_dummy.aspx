<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Default_Dummy.aspx.vb" MaintainScrollPositionOnPostback="true" Inherits="_Default" %>
...
<p>
                        <div class="anmeldeform">
                            <form id="Form1" method="post" runat="server">
                                ...
                                <p class="accordion_panel_absatz"><strong>Persönliche Daten</strong></p>
                                    ...
                                    <p class="accordion_panel_absatz"><strong>Anmeldung</strong></p>

                                    <p class="volle_breite" style="margin-bottom:0px;padding-bottom:0px;">
                                        <asp:RadioButton ID="teilnahme_ja" GroupName="teilnahme" runat="server" Text="Ja, ich nehme teil und habe meine Teilnahme mit meiner Führungskaft abgesprochen." />
                                    </p>
                                   ...
                                   <p class="accordion_panel_absatz"><strong>Hotel</strong></p>
                                    ...
                                    <p class="volle_breite">
                                     ...
                                     <table>
                                        ...
                                        <p class="accordion_panel_absatz"><strong>Shuttle</strong></p>
                                    <table>
                                           <tr>
