...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To GridView1.Rows.Count - 1
            ...
            mailsub = "Ihr Feedback zur Canon Partner Keynote 2017"
            ...
            text = text & "                                       am 26. Juni 2017 haben wir Ihnen die kommenden Canon Produktneuheiten präsentiert und gaben Ihnen einen tieferen Einblick in die CIG Sales- und Marketingstrategie. Wir hoffen natürlich, Ihnen hat unsere Veranstaltung gefallen."
            text = text & "                                    </p>"

            text = text & "                                    <p style=""color:#4A4D4E;"">Hiermit bedanken wir uns für Ihre Teilnahme und möchten Sie bitten, uns Ihr Feedback zur Veranstaltung zu geben, um bei kommenden Veranstaltungen noch besser auf Ihre Bedürfnisse eingehen zu können. <br><a href = ""http://partner-keynote2017-feedback.canon-events.de?id=" & hash & """><br><img src=""http://canon-events.de/img_std/Button_Feedback.png""/></a></p>"
            ...
            'text = text & "                                    <p>"
            text = text & "                                       <p style=""color:#4A4D4E; font-weight:bold;"">Wir freuen uns, Sie auch demnächst wieder begrüßen zu dürfen!</p>"
            ...
            text = text & "                                    <p style=""color:#4A4D4E;  margin-bottom:0px;"">Ihr Canon Event-Team</p>"
            ...
            plaintext = plaintext & "am 26. Juni 2017 haben wir Ihnen die kommenden Canon Produktneuheiten präsentiert und gaben Ihnen einen tieferen Einblick in die CIG Sales- und Marketingstrategie. Wir hoffen natürlich, Ihnen hat unsere Veranstaltung gefallen." & vbNewLine & vbNewLine

            plaintext = plaintext & "Hiermit bedanken wir uns für Ihre Teilnahme und möchten Sie bitten, uns Ihr Feedback zur Veranstaltung zu geben, um bei kommenden Veranstaltungen noch besser auf Ihre Bedürfnisse eingehen zu können. <br><a href = ""http://partner-keynote2017-feedback.canon-events.de?id=" & hash & """><br><img src=""http://canon-events.de/img_std/Button_Feedback.png""/></a>" & vbNewLine & vbNewLine
            plaintext = plaintext & "Wir freuen uns, Sie auch demnächst wieder begrüßen zu dürfen!" & vbNewLine & vbNewLine
