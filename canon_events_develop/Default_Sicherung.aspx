...
Empfang bei Snacks und Getränken / Experience Center Tour</td>
 ...
 <tr>
  ...
  <td style="border: 0px solid red;"></td>
  <td valign="top">Get Together & Dinner im Convention Center</td>  
 </tr>
 <tr>
...
Empfang bei Snacks und Getränken / Experience Center Tour</td>
 ...
 <tr>
  <td style="width: 100% !important"><strong>17:30 - 22:00 Uhr</strong><br />Get Together & Dinner im Convention Center</td>
 </tr>
 <tr>
...
47807 Krefeld, Germany
  ...
  <p class="accordion_panel_absatz">
  Hotel: Für den Fall, dass Sie Ihr Hotel selbst und auf eigene Kosten buchen möchten, haben wir für Sie einen vergünstigten Hotelpreis vereinbart.</p>

<p class="accordion_panel_absatz">
Taxi: <span style="color: red;">Volupta sandigniam, net re voluptam que sae pore il intur aut omnim vendero bla eost, auda veliatur restruptatem as aut quodiori beaqui omnis imolorp oreheni cus evereprat voluptatur sincid et idignih.</span>
...
<button class="accordion">Persönliche Daten</button>
<div class="panel">
  <p class="accordion_panel_absatz">
...
<div class="anmeldeform">
   ...
   <p class="volle_breite"><asp:TextBox ID="vorname" runat="server"  placeholder="Vorname*"></asp:TextBox></p>
   
   <p class="volle_breite"><asp:TextBox ID="nachname" runat="server"  placeholder="Nachname*"></asp:TextBox></p>
   
   <p class="volle_breite"><asp:TextBox ID="Bereich" runat="server"  placeholder="Bereich*"></asp:TextBox></p>
   
   <p class="volle_breite"><asp:TextBox ID="Vorgesetzter" runat="server"  placeholder="Name des Vorgesetzten*"></asp:TextBox></p>

   <p class="volle_breite"><asp:TextBox ID="email" runat="server"  placeholder="E-Mail-Adresse*"></asp:TextBox></p>

    
   
   <p class="volle_breite"><asp:RadioButton ID="teilnahme_ja" AutoPostBack="true" Checked="true" GroupName="teilnahme" runat="server" Text="Ja, ich nehme teil und habe meine Teilnahme mit meiner Führungskaft abgesprochen." /></p>
   <p class="volle_breite"><asp:RadioButton ID="teilnahme_nein" AutoPostBack="true" GroupName="teilnahme" runat="server" Text="Nein, ich nehme nicht teil." /></p>


   
   <p class="volle_breite"><asp:TextBox ID="bemerkung" runat="server" TextMode="MultiLine" Rows="4" placeholder="..." Visible="false"></asp:TextBox></p>
            <asp:Panel ID="shuttle" runat="server">
                <p class="volle_breite"><asp:RadioButton ID="shuttle_ja" AutoPostBack="true" Checked="true" GroupName="shuttle" runat="server" Text="Ja, ich möchte den Shuttle-Service zwischen TEMPODROM und NH-Hotel nutzen" /></p>
                <p class="volle_breite"><asp:RadioButton ID="shuttle_nein" AutoPostBack="true" GroupName="shuttle" runat="server" Text="Nein, ich möchte den Shuttle-Service zwischen TEMPODROM und NH-Hotel nicht nutzen." /></p>
            </asp:Panel>
            <p class="volle_breite" style="color:#ff0000; font-weight:bold;">
                <asp:Label ID="fehlermeldung" runat="server" Visible="false" >Bitte fülle die markierten Felder aus und drücke auf "Absenden".</asp:Label></p>
   <p class="volle_breite">
       <asp:Button ID="Button1" runat="server" Text="Absenden" /></p>

        </asp:Panel>
        <asp:Panel ID="anmeldung_absage" runat="server">
            
            <p class="volle_breite">
                Anrede:<br /><asp:Textbox Enabled="false" ID="absage_anrede" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                Name:<br /><asp:Textbox ID="absage_name" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                Bereich:<br /><asp:Textbox ID="absage_bereich" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                Name des Vorgesetzten:<br /><asp:Textbox ID="absage_vorgesetzter" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                E-Mail:<br /><asp:Textbox ID="absage_email" runat="server"></asp:Textbox>
            </p>
            
           <%-- <p class="volle_breite">
                Grund der Absage:<br /><asp:Textbox ID="absage_grund" runat="server"></asp:Textbox>
            </p>--%>


        </asp:Panel>
        <asp:Panel ID="anmeldung_zusage" runat="server">
            
            <p class="volle_breite">
                Anrede:<br /><asp:Textbox Enabled="false" ID="zusage_anrede" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                Name:<br /><asp:Textbox Enabled="false" ID="zusage_name" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                Bereich:<br /><asp:Textbox Enabled="false" ID="zusage_bereich" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                Name des Vorgesetzten:<br /><asp:Textbox Enabled="false" ID="zusage_vorgesetzter" runat="server"></asp:Textbox>
            </p>
            <p class="volle_breite">
                E-Mail:<br /><asp:Textbox Enabled="false" ID="zusage_email" runat="server"></asp:Textbox>
            </p>
            
            <p class="volle_breite">
                Extrashuttle:<br /><asp:Textbox Enabled="false" ID="zusage_shuttle" runat="server"></asp:Textbox>
            </p>
            <hr />
            <p class="volle_breite"><br />Solltest Du Deine Teilnahme nach bereits abgeschlossener Anmeldung dennoch absagen müssen, nutze bitte den nachfolgenden Button.</p>
            <p class="volle_breite"><asp:Button ID="Button3" CssClass="abmeldung" runat="server" Text="Zur Abmeldung" /></p> 
        </asp:Panel>
        <asp:Panel ID="anmeldung_warteliste" runat="server">
            <p class="volle_breite">Die Plätze für das Pathfinder Event sind leider schon ausgebucht. Für den Fall, dass Plätze frei werden, kannst Du Dich auf die Warteliste setzen lassen.</p>
            <p class="volle_breite"><asp:Button ID="Button2" runat="server" Text="Ich möchte auf die Warteliste" /></p> 

        </asp:Panel>
        <asp:Panel ID="anmeldung_zu" runat="server" Visible="false">
            <p class="volle_breite" style="text-align:center;"><br />Die Anmeldung ist leider nicht mehr möglich.</p>
        </asp:Panel>
   </form>
