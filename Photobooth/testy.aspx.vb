...
Partial Class Ausgabe
    ...
    Public Sub sende_mail()
        ...
        'Dim remoteUri As String = "http://www.gate-multimedia.de/Fotobooth/Device1/05_10_2017/"
        'Dim photoname As String = "e.jpg"
        'Dim myStringWebResource As String = Nothing
        '' Create a new WebClient instance.
        'Dim myWebClient As New WebClient()
        '' Concatenate the domain with the Web resource filename. Because DownloadFile 
        ''requires a fully qualified resource name, concatenate the domain with the Web resource file name.
        'myStringWebResource = remoteUri + photoname
        'Console.WriteLine("Downloading File ""{0}"" from ""{1}"" ......." + ControlChars.Cr + ControlChars.Cr, photoname, myStringWebResource)
        '' The DownloadFile() method downloads the Web resource and saves it into the current file-system folder.
        'myWebClient.DownloadFile(myStringWebResource, photoname)
        'Console.WriteLine("Successfully Downloaded file ""{0}"" from ""{1}""", photoname, myStringWebResource)
        ''Console.WriteLine((ControlChars.Cr + "Downloaded file saved in the following file system folder:" + ControlChars.Cr + ControlChars.Tab + Application.StartupPath))
        Dim targetpath As String = Server.MapPath("/Email/email.jpg")
        Dim str As Stream = New FileStream("http://www.gate-multimedia.de/Fotobooth/" & ordnername & "/" & dummy, FileMode.Open)
        'GenerateThumbnails(1.0, stream, "~/img/E.jpg")

        GenerateThumbnails(0.07, Str, targetpath)
        ...
        text = text & "<td style=""width:272px;vertical-align:top;text-align:right;""><a href=""http://photobooth.gate-internet.de/foto.aspx?id=" & hash & """><img src=""http://photobooth.gate-internet.de/Email/email.jpg"" border=""0"" alt="""" /></a></td></tr>"
