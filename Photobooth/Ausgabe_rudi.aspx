<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="Ausgabe_rudi.aspx.vb" Inherits="Ausgabe" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://graph.facebook.com/schema/og/" >
 ...
 <head>
  ...
  <meta name="viewport" content="initial-scale=1.0, user-scalable=no" />
   ...
   <link rel="stylesheet" href="css/style_ausgabe_rudi.css" type="text/css" />  
...
<asp:Panel ID="pnlContents" runat="server">
            ...
            <asp:Panel ID="PanelButtons" runat="server">
                <table style=" width: 50%; margin-top: 30px;" border="0" cellpadding="10" cellspacing="0">
          ...
          <div id="parent">
                ...
                <div id="navbar"  style="background-color:#fff;" width="100%">
                    

                        <table style=" width: 54.50%; margin-top: 28px;" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
