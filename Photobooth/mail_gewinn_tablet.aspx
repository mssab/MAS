...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        text = text & "                                      <b>GIGA-Glückwunsch</b> zum Gewinn <b>eines Vodafone Tab prime 7.</b> Im Rahmen der GigaCube Promotion in Dortmund bist Du unter den glücklichen Gewinnern."

        text = text & "                                    <p style=""color:#4A4D4E;"">"
        text = text & "                                      Das neue Tablet von Vodafone ist ein schlanker Allrounder, mit dem Du dank LTE-Unterstützung richtig schnell im Netz unterwegs bist. Du kannst damit unterwegs arbeiten oder Dich Zuhause aufs Sofa legen, Videos gucken, surfen oder zocken.</p>"
        ...
        text = text & "                                     <tr><td style=""width:270px;"">"
        ...
        text = text & "                                    <p style=""color:#4A4D4E;"">"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> Octa-Core-Prozessor<br />"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> Android 6.0 Betriebssystem<br />"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> Top-schlankes Design<br />"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> 10,1 Zoll-Display (25,65 cm)<br />"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> Bis zu 16 GB interner Speicherplatz<br />"
        text = text & "                                    <span style=""color:white;"">•</span> (erweiterbar)<br />"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> Nutzungszeit von bis zu 12 Stunden<br />"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> Standby-Zeit von bis zu 450 Stunden<br />"
        text = text & "                                    <span style=""color:#4A4D4E;"">•</span> Eine 5 Mgeapixelkamera<br />"

        text = text & "                                     </p>"

        text = text & "                                    <p style=""color:#4A4D4E;"">Lass uns für die Gewinnübergabe bitte <b>bis zum 14.06.2017</b> Deine <b>Mobilnummer</b> und Deine <b>Anschrift</b> zukommen.</p>"

        text = text & "                                    <p style=""color:#4A4D4E;""><br />Viel Spaß mit Deinem Gewinn<br /> und viele Grüße</p>"
        text = text & "                                    <p style=""color:#4A4D4E;""><b>Dein Vodafone GigaCube Team</b></p>"

        text = text & "                                     </td><td><img src=""http://gigacube-gewinnspiel.de/img/Stoerer_cube.jpg"" alt="""" /></td></tr>"
        ...
        plaintext = plaintext & "GIGA-Glückwunsch zum Gewinn eines Vodafone Tab prime 7. Im Rahmen der GigaCube Promotion in Dortmund bist Du unter den glücklichen Gewinnern." & vbNewLine & vbNewLine
        ...
        plaintext = plaintext & "Viel Spaß mit Deinem Gewinn und viele Grüße" & vbNewLine & vbNewLine
