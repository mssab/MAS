...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'End If
        text = text & "<p style=""color:#4A4D4E;font-weight:bold;font-size:14pt;"">Lieber Lawrence,</p>"
        text_anrede = "Lieber Lawrence,"
        ...
        text = text & "                                     <p>Bitte wende Dich zur persönlichen Übergabe an Denise Yoldjou.</p>"
        ...
        Try
            ...
            da = New Net.Mail.MailAddress("lawrence.annoh@vodafone.com")
