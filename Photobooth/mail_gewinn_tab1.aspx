...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'End If
        text = text & "<p style=""color:#4A4D4E;font-weight:bold;font-size:14pt;"">Lieber Jörg,</p>"
        text_anrede = "Lieber Jörg,"
        text = text & "                                    <p style=""color:#4A4D4E;"">"
        text = text & "                                      <b>GIGA-Glückwunsch</b> zum Gewinn <b>eines Vodafone Tab prime 7.</b> Im Rahmen der GigaCube Promotion am Campus Düsseldorf und in Unterföhring bist Du unter den glücklichen Gewinnern."
        ...
        text = text & "                                    <p style=""color:#4A4D4E;"">Bitte wende Dich zur persönlichen Übergabe an Denise Yoldjou</p>"
        ...
        Try
            ...
            da = New Net.Mail.MailAddress("joerg.stockinger@vodafone.com")
