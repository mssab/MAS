<%@ Page Language="VB" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="deinfoto.aspx.vb" Inherits="_Default" %>
...
<div class="wrapper">
  ...
  <h1 id="ha" runat="server">Teile Dein Foto</h1> 
  
   <div>
       <p>
            <asp:Label ID="resultload"  runat="server"></asp:Label>
