...
<script runat="server">
    ...
    Protected Sub senden_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For i = 0 To GridView1.Rows.Count - 1
            ...
            text = text & "                                    <p style=""color:#4A4D4E;"">Weitere Informationen zur Veranstaltung und die Möglichkeit zur Anmeldung <br>finden Sie hier:<br><a href = ""http://partner-keynote2017.canon-events.de?id=" & hash & """><br><img src=""http://canon-events.de/img_std/Button_Zur_Anmeldung.jpg""/></a></p>"
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Canon %>"
            ...
            SelectCommand="SELECT [id], [EMail], [Anrede], [Vorname], [Nachname], [Hash] FROM [Canon_Einladung] WHERE id in (13)">
        </asp:SqlDataSource>
    </div>
    </form>
</body>
